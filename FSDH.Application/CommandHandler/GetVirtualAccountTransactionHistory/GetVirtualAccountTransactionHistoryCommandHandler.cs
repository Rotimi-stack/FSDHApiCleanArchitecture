...
{
    public class GetVirtualAccountTransactionHistoryCommandHandler : IRequestHandler<GetVirtualaccountTransactionHistoryCommand, GetVirtualaccountTransactionHistoryResponse>
    {
        ...
        public async Task<GetVirtualaccountTransactionHistoryResponse> Handle(GetVirtualaccountTransactionHistoryCommand request, CancellationToken cancellationToken)
        {
