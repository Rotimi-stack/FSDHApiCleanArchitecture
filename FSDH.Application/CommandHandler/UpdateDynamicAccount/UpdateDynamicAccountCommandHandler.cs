...
{
    public class UpdateDynamicAccountCommandHandler : IRequestHandler<UpdateDynamicAccountCommand, UpdateDynamicAccountResponse>
    {
        ...
        public async Task<UpdateDynamicAccountResponse> Handle(UpdateDynamicAccountCommand request, CancellationToken cancellationToken)
        {
