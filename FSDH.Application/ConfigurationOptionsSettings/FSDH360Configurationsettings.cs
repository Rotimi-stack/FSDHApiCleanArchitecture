...
namespace FSDH.Application.ConfigurationOptionsSettings
{
    public class FSDH360Configurationsettings
    {
        public string TestAPIKey { get; set; }
        public string BaseUrl { get; set; }

        public string BaseAddress { get; set; }
        public string GetassignedDynamicAccountURL { get; set; }

    }
}


/*This class uses the principles of options pattern
