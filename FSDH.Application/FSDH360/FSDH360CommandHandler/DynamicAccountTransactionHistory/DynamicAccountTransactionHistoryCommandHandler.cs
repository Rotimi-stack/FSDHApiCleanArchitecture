...
{
    public class DynamicAccountTransactionHistoryCommandHandler : IRequestHandler<DynamicAccountTransactionHistoryCommand, List<GetDynamicAccountTransactionHistory>>
    {
        ...
        public async Task<List<GetDynamicAccountTransactionHistory>> Handle(DynamicAccountTransactionHistoryCommand request, CancellationToken cancellationToken)
        {
