...
{
    public class UpdateStaticVirtualAccountCommandHandler : IRequestHandler<UpdateStaticVirtualAccountCommand, List<UpdateStaticVirtualAccountResponse>>
    {
        ...
        public async Task<List<UpdateStaticVirtualAccountResponse>> Handle(UpdateStaticVirtualAccountCommand request, CancellationToken cancellationToken)
        {
