...
{
    public class GetAllStaticAccountQueryHandler : IRequestHandler<GetAllStaticAccountQuery, List<GetAllstaticAccount>>
    {
        ...
        public async Task<List<GetAllstaticAccount>> Handle(GetAllStaticAccountQuery request, CancellationToken cancellationToken)
        {
