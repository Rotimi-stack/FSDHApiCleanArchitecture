...
{
    public class GetAllStaticAccountLinkedtoBVNQueryHandler : IRequestHandler<GetAllStaticAccountLinkedtoBVNQuery, List<GetAllStaticAccountLinkedtoBVN>>
    {
        ...
        public Task<List<GetAllStaticAccountLinkedtoBVN>> Handle(GetAllStaticAccountLinkedtoBVNQuery request, CancellationToken cancellationToken)
        {
