...
{
    public class BalanceEnquiryQueryHandler : IRequestHandler<GetBalanceEnquiryQuery, List<GetBalanceEnquiryResponse>>
    {
        ...
        public Task<List<GetBalanceEnquiryResponse>> Handle(GetBalanceEnquiryQuery request, CancellationToken cancellationToken)
        {
            ...
            return _fSDHPay.GetBalanceEnquiry(request.AccountNumber,request.apiversion);
        }
    }
}
