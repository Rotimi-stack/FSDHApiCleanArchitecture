...
{
    public class GetFundsTransferQueryHandler : IRequestHandler<GetFundsTransferQuery, List<GetFundsTransferResponse>>
    {
        ...
        public async Task<List<GetFundsTransferResponse>> Handle(GetFundsTransferQuery request, CancellationToken cancellationToken)
        {
