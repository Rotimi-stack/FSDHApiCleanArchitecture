...
{
    public class GetAllCollectionLinkedAccountQueryHandler : IRequestHandler<GetAllCollectionLinkedAccountQuery, GetAllCollectionLinkedAccount>
    {
        ...
        public async  Task<GetAllCollectionLinkedAccount> Handle(GetAllCollectionLinkedAccountQuery request, CancellationToken cancellationToken)
        {
