...
{
    public class GetAllDynamicAssignedQueryHandler : IRequestHandler<GetAllDynamicAssignedQuery, GetAllAsignedDynamicAccount>
    {
        ...
        public async Task<GetAllAsignedDynamicAccount> Handle(GetAllDynamicAssignedQuery request, CancellationToken cancellationToken)
        {
