...
{
    public class GetBankQueryHandler : IRequestHandler<GetBanksQuery, GetBankResponse>
    {
        ...
        public Task<GetBankResponse> Handle(GetBanksQuery request, CancellationToken cancellationToken)
        {
